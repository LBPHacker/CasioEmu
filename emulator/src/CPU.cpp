...
namespace casioemu
{
	...
	CPU::OpcodeSource CPU::opcode_sources[] = {
		...
		{&CPU::OP_LS_EAP     ,                                0, 0x9052, {{2, 0x000E,  8}, {0,      0,  0}}},
		...
		{&CPU::OP_LS_EAP     ,                                0, 0x9050, {{2, 0x000E,  8}, {0,      0,  0}}},
		...
		{&CPU::OP_LS_EAP     ,                                0, 0x9054, {{4, 0x000C,  8}, {0,      0,  0}}},
		{&CPU::OP_LS_EA      ,                                0, 0x9036, {{8, 0x0008,  8}, {0,      0,  0}}},
		{&CPU::OP_LS_EAP     ,                                0, 0x9056, {{8, 0x0008,  8}, {0,      0,  0}}},
		{&CPU::OP_LS_EA      ,                             H_ST, 0x9033, {{2, 0x000E,  8}, {0,      0,  0}}},
		{&CPU::OP_LS_EAP     ,                             H_ST, 0x9053, {{2, 0x000E,  8}, {0,      0,  0}}},
		{&CPU::OP_LS_R       ,                             H_ST, 0x9003, {{2, 0x000E,  8}, {2, 0x000E,  4}}},
		{&CPU::OP_LS_I_R     ,                      H_TI | H_ST, 0xA009, {{2, 0x000E,  8}, {2, 0x000E,  4}}},
		{&CPU::OP_LS_I_BP    ,                      H_TI | H_ST, 0xB080, {{2, 0x000E,  8}, {0, 0x003F,  6}}},
		{&CPU::OP_LS_I_FP    ,                      H_TI | H_ST, 0xB0C0, {{2, 0x000E,  8}, {0, 0x003F,  6}}},
		{&CPU::OP_LS_I       ,                      H_TI | H_ST, 0x9013, {{2, 0x000E,  8}, {0,      0,  6}}},
		{&CPU::OP_LS_EA      ,                             H_ST, 0x9031, {{2, 0x000E,  8}, {0,      0,  0}}},
		{&CPU::OP_LS_EAP     ,                             H_ST, 0x9051, {{2, 0x000E,  8}, {0,      0,  0}}},
		{&CPU::OP_LS_R       ,                             H_ST, 0x9001, {{2, 0x000E,  8}, {2, 0x000E,  4}}},
		{&CPU::OP_LS_I_R     ,                      H_TI | H_ST, 0x9009, {{2, 0x000E,  8}, {2, 0x000E,  4}}},
		{&CPU::OP_LS_I_BP    ,                      H_TI | H_ST, 0xD080, {{2, 0x000E,  8}, {0, 0x003F,  6}}},
		{&CPU::OP_LS_I_FP    ,                      H_TI | H_ST, 0xD0C0, {{2, 0x000E,  8}, {0, 0x003F,  6}}},
		{&CPU::OP_LS_I       ,                      H_TI | H_ST, 0x9011, {{2, 0x000E,  8}, {0,      0,  6}}},
		{&CPU::OP_LS_EA      ,                             H_ST, 0x9035, {{4, 0x000C,  8}, {0,      0,  0}}},
		{&CPU::OP_LS_EAP     ,                             H_ST, 0x9055, {{4, 0x000C,  8}, {0,      0,  0}}},
		{&CPU::OP_LS_EA      ,                             H_ST, 0x9037, {{8, 0x0008,  8}, {0,      0,  0}}},
		{&CPU::OP_LS_EAP     ,                             H_ST, 0x9057, {{8, 0x0008,  8}, {0,      0,  0}}},
